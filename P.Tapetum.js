...
(lib.AfficheMandella = function() {
	this.initialize(img.AfficheMandella);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,5000,3750);


(lib.BadgeTipitumHorizontal = function() {
	this.initialize(img.BadgeTipitumHorizontal);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2250,1500);


(lib.potdepeinturegigapixel = function() {
	this.initialize(img.potdepeinturegigapixel);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2314,1380);


(lib.TapetumBG = function() {
	this.initialize(img.TapetumBG);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2850,1900);


(lib.TapitumAfficheMonalisa = function() {
	this.initialize(img.TapitumAfficheMonalisa);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,4500,3000);


(lib.TapitumAffiche = function() {
	this.initialize(img.TapitumAffiche);
}).prototype = p = new cjs.Bitmap();
...
if (reversed == null) { reversed = false; }
	...
	// rec
	this.instance = new lib.AfficheMandella();
	this.instance.setTransform(0,-74.05,0.192,0.192);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slide3, new cjs.Rectangle(0,-74,960,720), null);
...
if (reversed == null) { reversed = false; }
	...
	// text
	this.instance = new lib.TapitumAfficheMonalisa();
	this.instance.setTransform(0,-54,0.2133,0.2133);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slide1, new cjs.Rectangle(0,-54,960,640), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0.05,-45.9,0.3368,0.3368);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slide0, new cjs.Rectangle(0.1,-45.9,960,640), null);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.instance = new lib.potdepeinturegigapixel();
	this.instance.setTransform(-1120.6,-699.4);
...
p.nominalBounds = new cjs.Rectangle(-1120.6,-699.4,2314,1380);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E10270").s().p("Ai4GuIAAtbIFxAAIAANbg");
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-413.45},249,cjs.Ease.quadInOut).to({x:0},250,cjs.Ease.quadInOut).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1534,-699.4,2727.4,1380);
...
if (reversed == null) { reversed = false; }
	...
	// rec
	this.instance = new lib.BadgeTipitumHorizontal();
	this.instance.setTransform(0,-36.05,0.4267,0.4267);
...
}).prototype = getMCSymbolPrototype(lib.Slide4, new cjs.Rectangle(-1,-36,962,640), null);
...
if (reversed == null) { reversed = false; }
	...
	// rec
	this.instance = new lib.TapitumAffiche();
	this.instance.setTransform(0,-42,0.32,0.32);
...
}).prototype = getMCSymbolPrototype(lib.Slide2, new cjs.Rectangle(-1,-42,962,640), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(instanceFilter_1).to(new cjs.ColorFilter(0,0,0,1,224,0,111,0), 19).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 20).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(instance_2Filter_1).wait(29).to(new cjs.ColorFilter(0,0,0,1,220,3,110,0), 20).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 20,cjs.Ease.quintInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.prevButton},{t:this.nextButton}]}).wait(120));
...
p.nominalBounds = new cjs.Rectangle(-579.9,-74,2504.9,722);


// stage content:
(lib.PTapetum = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(471.8,177.8,718.3,444.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AfficheMandella.jpg", id:"AfficheMandella"},
		{src:"images/BadgeTipitumHorizontal.jpg", id:"BadgeTipitumHorizontal"},
		{src:"images/potdepeinturegigapixel.jpg", id:"potdepeinturegigapixel"},
		{src:"images/TapetumBG.jpg", id:"TapetumBG"},
		{src:"images/TapitumAfficheMonalisa.jpg", id:"TapitumAfficheMonalisa"},
		{src:"images/TapitumAffiche.jpg", id:"TapitumAffiche"}
	],
	preloads: []
};
